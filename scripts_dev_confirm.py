"""Confirmatory pilot (prereg-v2): 200 FRESH records, RIP-1.1.0 controls."""
import json
import time
...
PILOT_N = 200
OFFSET = 500  # fresh records, disjoint from the 500-record pilot (prereg-v2)
AGREEMENT_GATE = 0.8
...
s02_ledger = RunLedger(ROOT / "data/runs/confirm-s02.jsonl")
t0 = time.time()
...
obs_ledger = RunLedger(ROOT / "data/runs/confirm-obs.jsonl")
t1 = time.time()
done = [0]
